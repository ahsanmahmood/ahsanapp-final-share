            		...
            		<tbody>
            			@foreach($items as $item)
            				<tr>
            					...
            					<td>
            						<a href="{{ url('/admin/service-category/'.$item->id) }}">
            							<i class="fa fa-eye"></i>
            						</a>
            					</td>
            					<td>
            						<a href="{{ url('/admin/service-category/'.$item->id.'/edit') }}">
            							<i class="fa fa-edit"></i>
            						</a>
            					</td>
            					<td>
            						<form method="post" class="d-inline-block" action="{{ url('admin/service-category/'.$item->id) }}">
                                        @csrf
                                        @method('delete')
