...
<div class="custom_dive_1">
	...
	<div class="row border p-10 font-size-20">
		...
		<div class="col-xs-9">
			<a href="{{ url('admin/service-category/'.$product->id.'/edit') }}" class="btn btn-info">Edit</a>
			<form method="post" class="d-inline-block" action="{{ url('admin/service-category/'.$product->id) }}">
				@csrf
				@method('delete')
